export const guideSections = [
...

  {
    ...
    title: "Equipment",
    summary:
      "Rent out stored gear or install it at a venue to improve its income and shows.",
    ...
    sections: [
      ...
      },
      {
        ...
        text: [
          "Once you own a venue, use /my_equipment and choose Manage Gear. You can install or move a copy to one of your venues, or return an installed copy to rentals.",
          "Installed gear stops generating rental income. Instead, it adds hourly income to that venue and improves attendance and production for shows hosted there.",
    ...
    sections: [
      {
        ...
        text: [
          ...
          "Stored equipment earns rental income. Installed equipment contributes to its venue's income. Both build up over time.",
        ],
      },
      {
      ...
      },
      {
        ...
        text: [
          "Your /profile separates base venue income from bar upgrades, permanent venue staff, temporary show staff, active event boosts, and installed equipment.",
